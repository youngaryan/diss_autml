...
test_loss,acc ,test_bacc, all_preds, all_targets = validate(model, dataloader, criterion, config["device"])
print(f"✅ RAVDESS Generalization Test — Loss: {test_loss:.4f}, Balanced Accuracy: {test_bacc:.4f}, raw acc {acc:.4f}")
