#!/bin/bash
#SBATCH --job-name=hubert_Hyper
#SBATCH --output=/mnt/parscratch/users/ach21ag/private/diss_autml/speecbrain/logs/hyper/train_grpo_%j.log
#SBATCH --nodes=1
